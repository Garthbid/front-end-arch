    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-[#0a0a0a] text-white pt-24 pb-20 px-6 md:px-12 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-96 h-96 bg-[#224cff] blur-[150px] opacity-20" />

                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 text-[10px] font-black uppercase tracking-widest text-[#224cff] mb-6">
                    ...
                    <h1 className="text-6xl md:text-8xl font-display uppercase italic tracking-tighter leading-none mb-6">
                        Hamm<span className="text-[#224cff]">ered</span>
                    </h1>
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 -mt-12 relative z-20 pb-24">
                ...
                {/* Featured Post */}
                {featuredPost && (
                    <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-2xl border border-gray-100 flex flex-col md:flex-row gap-12 items-center mb-20 group cursor-pointer hover:shadow-[0_20px_60px_-15px_rgba(34,76,255,0.15)] transition-all duration-500" onClick={() => onReadPost(featuredPost.slug)}>
                        <div className="flex-1 space-y-6">
                            ...
                            <h2 className="text-4xl md:text-5xl font-display font-bold uppercase italic tracking-tighter text-gray-900 group-hover:text-[#224cff] transition-colors leading-[0.9]">
                                {featuredPost.title}
                            </h2>
                            ...
                            <button className="flex items-center gap-3 text-sm font-black uppercase tracking-widest text-[#224cff] group-hover:gap-5 transition-all">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
                    ...
                    <div className="relative w-full md:w-auto">
                        ...
                        <input
                            ...
                            className="w-full md:w-80 pl-12 pr-6 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm font-bold focus:bg-white focus:border-[#224cff] focus:outline-none transition-all"
                        />
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {otherPosts.map((post, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-display uppercase italic tracking-tighter text-gray-900 mb-3 group-hover:text-[#224cff] transition-colors leading-[0.9]">
                                    {post.title}
                                </h3>
