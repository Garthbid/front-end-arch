...
export type ViewState = 'HOME' | 'SEARCH' | 'FAVS' | 'PROFILE' | 'PUBLIC_PROFILE' | 'PAYMENT_FLOW' | 'ITEM_DETAIL' | 'INVOICES' | 'LISTINGS' | 'MEMBERSHIP' | 'DASHBOARD' | 'ITEM_DASHBOARD' | 'ITEM_BUILD_PROGRESS' | 'ADMIN' | 'AI_CHAT' | 'COMMUNITY';
